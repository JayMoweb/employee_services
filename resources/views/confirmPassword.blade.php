...
<body>
    ...
    width: 500px;">
		<form method="post" action="{{url('saveUpdatePassword/'.$token)}}" id="form" class="form-inline justify-content-center" style="margin: auto;">
			@csrf
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
		 ...
		 <div style="width: 180px;margin-left: auto;margin-right: auto;margin-top: 10px;">
			<input type="submit" class="btn btn-success" name="submit" value="Send new password">
		</div>	
		</form>
	</div>
	</div>
